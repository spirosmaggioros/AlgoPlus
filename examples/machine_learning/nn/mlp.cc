...
int main() {
    std::vector<std::vector<double>> perceptron_data = {
        ...
        {0.1, 0.2, 0.3, -1.0}, {0.15, 0.13, 0.25, -1.0}, {0.05, 0.07, 0.1, -1.0}, {0.0, 0.05, 0.1, -1.0},
        {0.2, 0.4, 0.0, -1.0}, {0.1, 0.13, 0.15, -1.0}, {0.05, 0.05, 0.1, -1.0}, {0.08, 0.08, 0.12, -1.0},
        {0.12, 0.15, 0.18, -1.0}, {0.03, 0.13, 0.15, -1.0}, {0.18, 0.08, 0.05, -1.0}, {0.07, 0.02, 0.03, -1.0},
        
        // Class +1 (right cluster)
        {1.2, 1.1, 1.4, 1.0}, {1.3, 1.1, 1.2, 1.0}, {1.1, 1.2, 1.3, 1.0}, {1.4, 1.3, 1.0, 1.0},
        {1.25, 1.15, 1.2, 1.0}, {1.35, 1.25, 1.5, 1.0}, {1.15, 1.35, 1.4, 1.0}, {1.05, 1.1, 1.2, 1.0},
        {1.1, 1.4, 1.7, 1.0}, {1.4, 1.2, 1.3, 1.0}, {1.3, 1.4, 1.4, 1.0}, {1.2, 1.3, 1.25, 1.0},
