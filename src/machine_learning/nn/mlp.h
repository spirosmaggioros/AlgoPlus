...
/*
* @brief Multilayer Perceptron class. Performs binary and categorical classification
* Uses nn::Linear as a sequential model, follows PyTorch's implementation.
...
public:
    ...
    * @param arch: 1D vector of pairs. Represents the [in_features, out_features] of each layer in the network
